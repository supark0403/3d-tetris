...
const COLORS := {
	...
	"J": Color(0.0, 0.0, 0.941),
	"L": Color(0.941, 0.627, 0.0),
}
...
const KICKS_JLSTZ := {
	0: {
		...
		2: [Vector2i(0, 0), Vector2i(0, -1), Vector2i(1, -1), Vector2i(-1, -1), Vector2i(1, 0), Vector2i(-1, 0)],
	},
	1: {
		...
		3: [Vector2i(0, 0), Vector2i(0, 1), Vector2i(1, 1), Vector2i(-1, 1), Vector2i(1, 0), Vector2i(-1, 0)],
	},
	2: {
		1: [Vector2i(0, 0), Vector2i(-1, 0), Vector2i(-1, -1), Vector2i(0, 2), Vector2i(-1, 2)],
		3: [Vector2i(0, 0), Vector2i(1, 0), Vector2i(1, -1), Vector2i(0, 2), Vector2i(1, -2)],
		0: [Vector2i(0, 0), Vector2i(0, 1), Vector2i(1, 1), Vector2i(-1, 1), Vector2i(1, 0), Vector2i(-1, 0)],
	},
	3: {
		2: [Vector2i(0, 0), Vector2i(-1, 0), Vector2i(-1, 1), Vector2i(0, -2), Vector2i(-1, -2)],
		0: [Vector2i(0, 0), Vector2i(-1, 0), Vector2i(-1, -1), Vector2i(0, 2), Vector2i(-1, 2)],
		1: [Vector2i(0, 0), Vector2i(0, -1), Vector2i(1, -1), Vector2i(-1, -1), Vector2i(1, 0), Vector2i(-1, 0)],
	},
}
...
const KICKS_I := {
	0: {
		...
		2: [Vector2i(0, 0), Vector2i(-1, 0), Vector2i(-2, 0), Vector2i(1, 0), Vector2i(2, 0), Vector2i(0, 1)],
	},
	1: {
		...
		3: [Vector2i(0, 0), Vector2i(0, 1), Vector2i(0, 2), Vector2i(0, -1), Vector2i(0, -2), Vector2i(-1, 0)],
	},
	2: {
		...
		0: [Vector2i(0, 0), Vector2i(-1, 0), Vector2i(-2, 0), Vector2i(1, 0), Vector2i(2, 0), Vector2i(0, -1)],
	},
	3: {
		...
		1: [Vector2i(0, 0), Vector2i(0, 1), Vector2i(0, 2), Vector2i(0, -1), Vector2i(0, -2), Vector2i(1, 0)],
	},
}
